...
package thing
{
	...
	public class thingsMain3 extends Sprite
	{
		private static var _main:thingsMain3;
		
		public static function get main():thingsMain3
		{
			if (_main == null)
				_main = new thingsMain3;
			return _main;
		}
		...
		public function thingsMain3()
		{
			_main = this;
			Tdata.windowIndex = 2;
			[Embed(source="asset/bg3.jpg")]
			var bg1png:Class;
