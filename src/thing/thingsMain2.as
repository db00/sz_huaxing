...
package thing
{
	...
	public class thingsMain2 extends Sprite
	{
		private static var _main:thingsMain2;
		
		public static function get main():thingsMain2
		{
			if (_main == null)
				_main = new thingsMain2;
			return _main;
		}
		...
		public function thingsMain2()
		{
			_main = this;
			Tdata.windowIndex = 1;
			[Embed(source="asset/bg2.jpg")]
			var bg1png:Class;
