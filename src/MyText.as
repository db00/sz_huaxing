...
package 
{
	...
	{
		private var html:Sprite = new Sprite();
		private var bar:Shape = new Shape();
		private var txt:TextField;

		public function MyText(xx:int,yy:int,ww:int,hh:int,str:String,size:uint=16,_color:uint=0x00000,canRoll:Boolean=false)
		{
