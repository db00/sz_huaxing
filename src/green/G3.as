...
package green
{
	...
	public class G3 extends Sprite
	{
		private static var _main:G3;
		public static function get main():G3
		{
			if(_main == null)
				_main = new G3;
			return _main;
		...
		public function G3()
		{
			...
			if(bmp){
				...
				titlepng.smoothing = true;
				var title:Bitmap = new titlepng;
				addChild(title);


				[Embed(source="asset/3/line.png")] var linepng:Class;
				linebmp = new linepng;
				...
				var i:int = 0;
				while(i<Gdata.btns12.length){
					var btn:Sprite;

					switch(i){
						case 0:
							btn=(ViewSet.makebtn(375,330,Gdata.btns12[i],200,200,clicked));
							[Embed(source="asset/3/b1.png")] var b1png:Class;
							var b1bmp:Bitmap = new b1png;
							b1bmp.smoothing = true;
							btn.addChild(b1bmp);
							break;
						case 1:
							btn = (ViewSet.makebtn(1250,250,Gdata.btns12[i],200,200,clicked));
							[Embed(source="asset/3/b2.png")] var b2png:Class;
							var b2bmp:Bitmap = new b2png;
							b2bmp.smoothing = true;
							btn.addChild(b2bmp);
							break;
						case 2:
							btn=(ViewSet.makebtn(1350,520,Gdata.btns12[i],200,200,clicked));
							[Embed(source="asset/3/b3.png")] var b3png:Class;
							var b3bmp:Bitmap = new b3png;
							b3bmp.smoothing = true;
							btn.addChild(b3bmp);
							break;
						case 3:
							btn=(ViewSet.makebtn(380,570,Gdata.btns12[i],200,200,clicked));
							[Embed(source="asset/3/b4.png")] var b4png:Class;
				...
				var s:String = SwfLoader.readfile(Gdata.Dir3+"info.txt");
				...
				[Embed(source="asset/3/center.png")] var centerpng:Class;
		...
		public function showBtns(e:Event=null):void
		{
			...
			//Moves.btnOut(getChildByName(Gdata.btns12[0]) as Sprite,375,300);
			//Moves.btnOut(getChildByName(Gdata.btns12[1]) as Sprite,1250,250);
			//Moves.btnOut(getChildByName(Gdata.btns12[2]) as Sprite,1350,520);
			//Moves.btnOut(getChildByName(Gdata.btns12[3]) as Sprite,380,570,showLines);
		...
		private function btnsOut(_i:int = 2):void
		{
			...
			var tween4:TweenLite = Moves.btnOut(getChildByName(Gdata["btns1"+_i][3]) as Sprite, 380, 570, showLines);
		...
		private function showBtnTxt(b:Boolean=true,_index:int=2):void
		{
