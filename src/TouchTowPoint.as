package
{
	...
	public class TouchTowPoint extends Sprite
	{
		...
		private function init(e:Event = null):void
		{
			...
			stage.addEventListener(KeyboardEvent.KEY_DOWN, mouseWheels);
		}
		
		private function mouseWheels(e:Event):void
		{
			var toscale:Number = scaleX;
			if (e.type == KeyboardEvent.KEY_DOWN)
			{
				trace(KeyboardEvent(e).keyCode);
				switch (KeyboardEvent(e).keyCode)
				{
					case Keyboard.UP: 
						trace("zoomup");
						toscale = scaleX * 1.1;
